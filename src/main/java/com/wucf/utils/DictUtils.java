...
public class DictUtils {
    ...
    public static List<SysDictData> getDictCache(String key) {
        Object cacheObj = CACHE.get( getCacheKey(key));
    ...
    public static String getDictLabel(String dictType, String dictValue, String separator) {
        ...
        if (StringUtils.containsAny(separator, dictValue) && Objects.nonNull(dataList)) {
    ...
    public static String getDictValue(String dictType, String dictLabel, String separator) {
        ...
        if (StringUtils.containsAny(separator, dictLabel) && Objects.nonNull(dataList)) {
            for (SysDictData dict : dataList) {
    ...
    public static void removeDictCache(String key) {
        CACHE.remove(getCacheName(), getCacheKey(key));
    }
