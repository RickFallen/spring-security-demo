...
import com.wucf.system.mapper.SysConfigMapper;
import com.wucf.system.service.system.ISysConfigService;
import com.wucf.utils.CacheUtils;
...
import static com.wucf.utils.DictUtils.getCacheName;
...
public class SysConfigServiceImpl implements ISysConfigService {
    ...
    public String selectConfigByKey(String configKey) {
        String configValue = Convert.toStr(CacheUtils.get(getCacheKey(configKey)));
        ...
        if (Objects.nonNull(retConfig)) {
            CacheUtils.put(getCacheKey(configKey), retConfig.getConfigValue());
    ...
    public int insertConfig(SysConfig config) {
        ...
        if (row > 0) {
            CacheUtils.put(getCacheKey(config.getConfigKey()), config.getConfigValue());
        }
        return row;
    }
